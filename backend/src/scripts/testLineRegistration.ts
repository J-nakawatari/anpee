...
async function testLineRegistration() {
  try {
    ...
    console.log(`送信メッセージ: "${(event1.message as TextEventMessage).text}"`)
    ...
    console.log(`送信メッセージ: "${(event2.message as TextEventMessage).text}"`)
    ...
    console.log(`送信メッセージ: "${(event3.message as TextEventMessage).text}"`)
    ...
    console.log(`送信メッセージ: "${(event4.message as TextEventMessage).text}"`)
