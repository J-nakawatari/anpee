...
class NotificationService {
    ...
    async createNotification(data) {
        try {
            ...
            // リアルタイムで送信
            notificationEmitter.emit(`notification:${data.userId.toString()}`, notification.toObject());
    ...
    // 応答があったときの通知
    async notifyResponse(userId, elderlyId, elderlyName) {
    ...
    // 応答がなかったときの通知
    async notifyNoResponse(userId, elderlyId, elderlyName, retryCount) {
    ...
    // 管理者への通知
    async notifyAdmin(userId, elderlyId, elderlyName) {
        return this.createNotification({
            userId,
            type: 'no_response',
            title: '緊急：管理者通知',
